...
const pedido_store = {
  ...
  categories:{
    ...
    items:{
      ...
      'I1':{
      //NOMBRE DEL ITEM
      name:'InstaBotExtractor',
      desc:'Licencia LifeTime',
      //PRECIO BASE DEL ITEM
      price:399,
      //CANTIDAD ESCOGIDA DEL ITEM
      qty:0,
      //FUENTE DE LA IMAGEN
      img:'img/instabotextractor2.webp',
      linkpago:'https://payp.page.link/BMdB',
    
      },
      'I2':{
      name:'WhatsApp Masivo para PC',
      desc:'Licencia LifeTime',
      price:399,
      qty:0,
      img:'img/whatsappmarketingpc2.webp',
      linkpago:'https://payp.page.link/7Lic',
      },
      'I3':{
      name:'Entrenador para WhatsApp Masivo',
      desc:'Licencia LifeTime',
      price:199,
      qty:0,
      img:'img/bottrainaccounts2.webp',
      linkpago:'https://payp.page.link/4ho4',
      },
      'I4':{
      name:'WhatsApp Masivo para Mac',
      desc:'Licencia LifeTime',
      price:399,
      qty:0,
      img:'img/whatsappbusinessmarketing2.webp',
      linkpago:'https://payp.page.link/7Lic',
      },
    },
      /*NOMBRE CATEGORIA*/
    ...
    'C2':{
       items:{
        ...
        'I1':{
          //NOMBRE DEL ITEM
          name:'Extractor de Correos y Números de contacto',
          desc:'',
          //PRECIO BASE DEL ITEM
          price:199,
          //CANTIDAD ESCOGIDA DEL ITEM
          ...
          price:199,
          qty:0,
          img:'img/botmailsender2.webp',
           linkpago:'https://payp.page.link/4ho4',
          
        },
          'I4':{
          name:'WhatsApp Masivo para Chrome',
          desc:'',
          price:299,
          qty:0,
          img:'img/whatsappmarketingchromeapp2.webp',
           linkpago:'https://payp.page.link/XHYo',
          },
      },
    ...
    'C3':{
      items:{
        ...
        'I1':{
          ...
          qty:0,
          //FUENTE DE LA IMAGEN
          img:'imgdos/whatsapp-ecommerce.webp',
           linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
          },
          ...
          price:130.00,
          qty:0,
          img:'imgdos/curso-enbudo-de-ventas.webp',
           linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
          
        },
          'I3':{
          name:'Manejo de campañas Tik-Tok ADS',
          desc:'',
          price:130.00,
          qty:0,
          img:'imgdos/curso-tiktok-for-business.webp',
           linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
          },
          ...
          price:130.00,
          qty:0,
          img:'imgdos/curso-video-marketing-y-ventas.webp',
           linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
          
        },
      },
      namec:'Nuevos Servicios',
    },
  ...
  'C4':{
    items:{
      ...
      'I1':{
        ...
        qty:0,
        //FUENTE DE LA IMAGEN
        img:'imgdos/CURSO-FACEBOOK-ADS.webp',
         linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
        },
        ...
        price:130.00,
        qty:0,
        img:'imgdos/Capacitaciòn-asesoria-digital.webp',
         linkpago:'https://ppls.me/3ACMjLzJRe3045Kh29CdA',
...
for (var i = 0, length = radios.length; i < length; i++) {
  if (radios[i].checked) {
    ...
    var fanlink= document.getElementById('fantasmasend').textContent;
...
var whatsapp_number ="&text=*Orden exitosa*" + "%0A"+"*marketing-soft.com - 2022*"+ "%0A"+"✅ *Detalle de la orden:*"+"%0A"+"_Orden N°_"+"%20"+ "%20"+"---"+"%20"+orden+"%20"+"---"+ "%0A"+"_________________________" + "%0A"+mostrarpedidof+ "%0A"+"*Total:*"+ "%20"+ "$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+ "%0A"+"_________________________"+ "%0A"+'*🙂Datos del Cliente:*'+ "%0A"+mostrarfac+"%20"+mostrarcedula+nombre+email+whatsapp+"%20"+"_________________________" +"%0A"+ retornapagos+cambio+"%0A"+fanlink+"%20"+"%0A"+"*Total:*"+ "%20"+"$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+"%0A"+"%0A"+"*Orden N°:*"+ "%20"+orden;
...
function limpiarformas(){
  ...
  // var fantasmalink=document.getElementById('fantasmasend').addClass('nover');
...
function limpiarformaspy(){
  ...
  document.getElementById('entry.580204725').textContent='';
  // var fantasmalink=document.getElementById('fantasmasend').addClass('ver');
...
$('.modalv').on('click', function(){$('.modalv').addClass('nosvemos2')})
  ...
  $('#containers2b').insertAfter('#menu-container-C2');
