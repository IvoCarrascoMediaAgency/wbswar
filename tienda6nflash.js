      ...
      'C2':{
         items:{
            ...
            'I2':{
                ...
                detalles:'<div class="contenedor-preguntas"><div class="contenedor-pregunta"><p class="pregunta">Ver detalles <span class="icon-negocio"></span></p><ul class="features"><li><i></i> <span class="masc">100 Licencias</span></li><li><i></i>Demos ilimitadas</li><li><i class="fas fa-stop-circle"></i>Comisiones 100%</li><li><i></i>Capacitación Personalizada</li><li><i></i>Software con tu propia marca, colores, logotipos, número de contacto, artes digitales, links RRSS.</li></ul></div></div>',
